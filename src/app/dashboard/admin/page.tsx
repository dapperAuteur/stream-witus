      ...
      {canModerate(role) && (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link href="/dashboard/admin/episodes"
            ...
            <p className="text-xs text-gray-500 mt-0.5">Import from Disctopia, manage, publish/unpublish.</p>
          </Link>
          <Link href="/dashboard/admin/moderation"
            className="block bg-white border border-gray-200 rounded-2xl p-5 hover:border-fuchsia-300 transition">
            <h2 className="text-sm font-semibold text-gray-700">Moderation →</h2>
            <p className="text-xs text-gray-500 mt-0.5">Feature public clubs; take down discussion posts.</p>
          </Link>
        </div>
      )}
